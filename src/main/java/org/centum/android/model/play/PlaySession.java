...
public class PlaySession implements Externalizable {
    ...
    public static final int EVENT_TIME_CHANGED = 0;
    public static final int EVENT_ENABLED_CHANGED = 0;
    public static final int EVENT_STATS_CHANGED = 0;
    ...
    private HashMap<Card, Integer> stats = new HashMap<Card, Integer>();
    private List<PlaySessionListener> playSessionListeners = new ArrayList<PlaySessionListener>();
    ...
    public Card[] getCards() {
        return stats.keySet().toArray(new Card[0]);
    }
