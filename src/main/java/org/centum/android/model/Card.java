...
public class Card implements Externalizable {
    ...
    private final List<CardListener> listeners = new ArrayList<CardListener>();
    ...
    public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        ...
        if (version > 2) {
            quizletTermID = objectInput.readInt();
        }
    }
    ...
    public void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeInt(quizletTermID);
    }
    ...
    public Card clone() {
        ...
        card.setQuizletTermID(getQuizletTermID());
        return card;
    }

    public int getQuizletTermID() {
        return quizletTermID;
    }

    public void setQuizletTermID(int quizletTermID) {
        this.quizletTermID = quizletTermID;
    }
