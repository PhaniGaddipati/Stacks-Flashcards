...
public class CardListAdapter extends ArrayAdapter implements StackListener {
    ...
    public CardListAdapter(CardFragment fragment, Stack stack) {
        super(fragment.getActivity(), R.layout.card_list_item, stack.getCardList());
    ...
    public View getView(int i, View view, ViewGroup parent) {
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.card_list_item, parent, false);
