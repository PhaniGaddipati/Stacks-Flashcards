...
public class ArchivedCardsActivity extends Activity implements StackListener, AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonBarLayout = (LinearLayout) findViewById(R.id.button_bar);
                        ...
                        new SwipeDismissGridViewTouchListener.DismissCallbacks() {
                            ...
                            public void onDismiss(GridView gridView, final int[] reverseSortedPositions) {
                                ...
                                for (int position : reverseSortedPositions) {
                                    if (position < stack.getNumberOfArchivedCards()) {
                                        removedCards.add(stack.getArchivedCard(position));
                                    }
                                }
                                ...
                                UndoBarController.show(ArchivedCardsActivity.this, "Card deleted.", new UndoBarController.UndoListener() {
                                    @Override
