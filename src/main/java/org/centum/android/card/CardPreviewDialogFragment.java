...
public class CardPreviewDialogFragment extends DialogFragment {
    ...
    public CardPreviewDialogFragment(Card card) {
        this.card = card;
    }

    public CardPreviewDialogFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (card != null) {
            PlayCardView cardView = (PlayCardView) inflater.inflate(R.layout.play_card_item, null, false);
