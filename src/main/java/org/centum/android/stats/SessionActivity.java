 ...
 */
public class SessionActivity extends Activity implements SwipeDismissListViewTouchListener.DismissCallbacks, AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SwipeDismissListViewTouchListener dismissListener = new SwipeDismissListViewTouchListener(listView, this);
    ...
    public void onDismiss(ListView listView, int[] reverseSortedPositions) {
        ...
        UndoBarController.show(this, "Session removed.", new UndoBarController.UndoListener() {
            @Override
