...
public class StatsPieView extends RelativeLayout {
    ...
    private void update() {
        ...
        if (playStats != null && playStats.getNumberOfSessions() > 1) {
            sessionTextView.setText(playStats.getNumberOfSessions() + (playStats.getNumberOfSessions() > 1 ? " sessions enabled" : " session enabled"));
        } else {
    ...
    public void removeBackground() {
        statsRelativeLayout.setBackgroundResource(0);
    }
