...
public final class StacksDatabaseContract {
    ...
    public static abstract class CardEntry implements BaseColumns {
        ...
        public static final String COLUMN_QUIZLET_TERM_ID = "quizletTermID";
        ...
        public static final String SQL_CREATE_TABLE =
                "CREATE TABLE " + TABLE_NAME + " (" + _ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                        ...
                        COLUMN_QUIZLET_TERM_ID + INT_TYPE + COMMA_SEP +
                        FOREIGN_KEY_OPEN + COLUMN_PARENT_STACK + FOREIGN_KEY_CLOSE + StackEntry.TABLE_NAME + "(" + StackEntry._ID + ") ON DELETE CASCADE )";

        public static final String SQL_ADD_TERM_ID_COLUMN =
                "ALTER TABLE " + TABLE_NAME + " ADD COLUMN " + COLUMN_QUIZLET_TERM_ID + INT_TYPE;
