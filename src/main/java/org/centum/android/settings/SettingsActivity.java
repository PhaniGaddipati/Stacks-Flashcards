...
public class SettingsActivity extends Activity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String KEY_PREF_STACK_TITLE_SIZE = "pref_key_stack_title_size";
    public static final String KEY_PREF_CARD_TITLE_SIZE = "pref_key_card_title_size";
    public static final String KEY_PREF_STACK_DESCRIPTION_SIZE = "pref_key_stack_description_size";
    public static final String KEY_PREF_CARD_DETAILS_SIZE = "pref_key_card_details_size";
    public static final String KEY_PREF_PLAY_TITLE_SIZE = "pref_key_play_title_size";
    public static final String KEY_PREF_PLAY_DETAILS_SIZE = "pref_key_play_details_size";
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(KEY_PREF_THEME)) {
            ...
            startActivity(i);
        } else if (key.equals(KEY_PREF_CARD_TITLE_SIZE) || key.equals(KEY_PREF_STACK_TITLE_SIZE)
                || key.equals(KEY_PREF_CARD_DETAILS_SIZE) || key.equals(KEY_PREF_STACK_DESCRIPTION_SIZE)) {
            restartOnBack = true;
        }
    }
}
