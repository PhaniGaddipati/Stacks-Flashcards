...
public class SwipeDismissGridViewTouchListener implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (mViewWidth < 2) {
            mViewWidth = mGridView.getWidth() / mGridView.getNumColumns();
        }
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                mGridView.getLocationOnScreen(listViewCoords);
                int x = (int) motionEvent.getRawX() - listViewCoords[0];
                int y = (int) motionEvent.getRawY() - listViewCoords[1];
                View child;
                for (int i = 0; i < childCount; i++) {
                    child = mGridView.getChildAt(i);
                ...
                if (mDownView != null) {
                    ...
                    mDownPosition = mGridView.getPositionForView(mDownView);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (Math.abs(deltaX) > mSlop) {
                    ...
                    mGridView.onTouchEvent(cancelEvent);
                    cancelEvent.recycle();
                }
    ...
    private void dismiss(final View view, final int position, boolean dismissRight) {
        ...
        if (view == null) {
            ...
            mCallbacks.onDismiss(mGridView, new int[]{position});
            return;
        }
    ...
    private View getViewForPosition(int position) {
        ...
        return (index >= 0 && index < mGridView.getChildCount())
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mDismissAnimationRefCount == 0) {
                    ...
                    mCallbacks.onDismiss(mGridView, dismissPositions);
